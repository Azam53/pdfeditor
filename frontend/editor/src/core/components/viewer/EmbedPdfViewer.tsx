...
const EmbedPdfViewerContent = ({
  ...
  useEffect(() => {
    ...
    // Azam Viewer Auto Save
  useEffect(() => {

    const saveUrl =
      sessionStorage.getItem("pdf_editor_save_url");
    ...
    const interval = setInterval(async () => {
      ...
      try {
        ...
        console.log("VIEWER AUTOSAVE");

        const arrayBuffer =
          await exportActions.saveAsCopy();
